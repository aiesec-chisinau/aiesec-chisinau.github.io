      ...
      <div className="OTM_contact_page">
        ...
        <div id="projects_midpage">
          <div className="project_div">
            <div className="projectfloatleft">
              <img width="100%" src="/images/onthemap/logo_black.png" />
            </div>
            <div className="projectfloatright">
              ...
              <br />
              #SDG8, tourism, Moldtava, GV, EXPA,{" "}
              <Link to={"/onthemap"}>{t("projects.seemore")}</Link>
            </div>
          </div>
          <hr style={{ marginLeft: "10%", width: "80%" }} />
          <br />
