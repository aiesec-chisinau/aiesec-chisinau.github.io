      ...
      <>
        ...
        <div className="OTM_more_page">
          ...
          <div className='OTM_more_qa'  onClick={() => {
            ...
            <div className='OTM_more_qa_row'>
              <div className='OTM_more_qa_text'>{t("otm_more.q2")} <span style={{fontFamily:'Pacifico'}}>On the map</span></div>
              <div className='OTM_more_qa_arrow'><ExpandMoreIcon id='OTM_more_arr2'/></div>
            </div>
            <div id='OTM_more_ans2' className=' OTM_more_ans hide'> &nbsp;&nbsp;&nbsp;{t("otm_more.a2")}</div>
