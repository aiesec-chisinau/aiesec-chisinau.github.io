...
const OTMformPage: React.FC = () => {
  ...
  const form1 = () => {
    window.location.href =
      "https://docs.google.com/forms/d/e/1FAIpQLSdnJzW_H1UOfmwQeMKdg03neWKN942VDyU_6cEfW6qwJM03WQ/viewform";
  };
      ...
      <div id="OTM_apply">
        <div id="OTM_apply_choseperiod">
          <div
            ...
            className="show OTM_apply_choose_preiod"
          >
            <b> {t("otm_apply.period0")}</b> <br />
            <span style={{ color: "#888888" }}>
              {t("otm_apply.period0dates")}
            </span>
          </div>
          <div
            onClick={() => {
            ...
            style={{ color: "#037EF3", border: "3px solid #037EF3" }}
            className="show OTM_apply_choose_preiod"
          >
            <b> {t("otm_apply.period1")}</b> <br />
            <span style={{ color: "#888888" }}>
              {t("otm_apply.period1dates")}
            </span>
          </div>
          ...
          <div
            style={{
              color: "#FBCE14",
              border: "1px solid #FBCE14",
              opacity: "0.3",
            }}
            className="OTM_apply_choose_preiod"
          >
            <b> {t("otm_apply.period2")}</b> <br />
            <span style={{ color: "#888888" }}>
              {t("otm_apply.period2dates")}
            </span>
          </div>
          <div
            style={{
              color: "#D1312F",
              border: "1px solid #D1312F",
              opacity: "0.3",
            }}
            className="OTM_apply_choose_preiod"
          >
