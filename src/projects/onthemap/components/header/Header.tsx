      ...
      <header className="otm_home_header">
        <div className=" otm_home_container otm_home_header__container">
          <Link to={"/onthemap"} style={{ color: "#222222" }}>
            <div className="otm_home_header__logo">
              <img
                className="otm_home_header__img"
                height="25px"
                width="25px"
                src="/images/onthemap/logo_black.png"
              />
              <h1 className="otm_home_header__title">
                On the map<span className="otm_home_header__light"></span>
              </h1>
            </div>
          </Link>
            ...
            <nav id="navbar" className="otm_home_header__nav collapse">
              <ul className="otm_home_header__elenco">
                {location.pathname !== "/onthemap/contact" && (
                  <li className="otm_home_header__el">
                    {" "}
                    <Link
                      to="/onthemap/contact"
                      className=" otm_home_header__link "
                    >
                      {t("otm.contact")}
                    </Link>
                  </li>
                ...
                {location.pathname == "/onthemap" && (
                  <li className="otm_home_header__el otm_home_header__el--blue">
                    <Link
                      to="/onthemap/soon"
                      className="otm_home_btn otm_home_btn--white"
                    >
                      {t("otm.signin")} →
                    </Link>
                  </li>
                ...
                {location.pathname !== "/onthemap/contact" && (
                  <li
                    className="otm_home_header__el otm_home_header__link"
                    id="otm-header-lang"
                    style={{ padding: "0 " }}
                ...
                {location.pathname == "/onthemap/contact" && (
                  ...
                  >
                    {" "}
                    {t("navbar.language")}: &nbsp; {lang_seleced}
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </li>
                )}
              </ul>
